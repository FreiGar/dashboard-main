...
mybins <- c(0,60,120,240,480,Inf)  # limites dos bins
#mycolors <- c("#f7f7f7","#fee391","#fb6a4a","#cb181d","#67000d")  # cores dos dos bins
mycolors <- c("#edf8fb","#b2e2e2","#66c2a4","#2ca25f","#006d2c")
